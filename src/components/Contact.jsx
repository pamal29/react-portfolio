...
import { ScaleUp, FadeIn } from '../utils/ScrollAnimations';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full border-4 border-black rounded-xl p-4 pl-12 text-base sm:text-lg transition-all duration-300 resize-none
                              dark:bg-black dark:text-white dark:placeholder-white/40 dark:border-white"
                ></textarea>
              </div>
